...
export default () => {
  ...
  return (
    <>
      <main  style={{ backgroundImage: `url(${BgImage})`,backgroundPosition:'right',backgroundRepeat:'no-repeat',backgroundSize:'contain' }}>
                      ...
                      <Controller
                        ...
                        render={({
                          ...
                          <InputGroup>
                            ...
                            <Form.Control autoFocus onChange={e => onChange(e.target.value)}
                              onBlur={onBlur}
